...
plotdatas = [dat.Elec, dat.Hole, np.log10(dat.Hole+1.0E-12), dat.Hole-dat.Elec, dat.rho]
cmap0 = plt.cm.get_cmap("jet")
cmap1 = plt.cm.get_cmap("seismic")
cmaps = [cmap0, cmap0, cmap0, cmap1, cmap1]
ForceZeros = [False, False, False, True, True]
xslicemins = [nxcenter-dnx, csxcenter-1, csxcenter-1, nxcenter-dnx, nxcenter-dnx]
xslicemaxs = [nxcenter+dnx, csxcenter+2, csxcenter+2, nxcenter+dnx, nxcenter+dnx]
