...
static PyMethodDef forward_methods[] =
  {
    {"forward", forward, METH_VARARGS, NULL},
    {NULL, NULL, 0, NULL}
  };


static struct PyModuleDef forward_def =
  {
...
PyMODINIT_FUNC PyInit_forward(void)
{
  Py_Initialize();
  import_array();
  return PyModule_Create(&forward_def);
}
