...
plt.plot(dat.z[0:phinumzs],(dat.phi[nxcenter3,nycenter3,0:phinumzs]+dat.phi[nxcenter3-1,nycenter3,0:phinumzs]+dat.phi[nxcenter3-1,nycenter3,0:phinumzs]+dat.phi[nxcenter3-1,nycenter3-1,0:phinumzs])/4.0)
#plt.legend(loc = "lower left")
plt.xlabel("Z-Dimension (microns)", fontsize=12)
plt.ylabel('$\phi(x,y,z)$ [V]',fontsize=9)
plt.ylim(-5.0, 0.0)
